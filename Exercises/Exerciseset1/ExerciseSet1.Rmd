...
**Your Answers here:**
<br> 1. mytickers = c("SPY", "AAPL") from dataSet1.R
<br>
2. 
<br>
Cumulative: round(100*sum(StockReturns[,"AAPL"]),1)

Average daily: round(100*mean(StockReturns[,"AAPL"]),3)

Standard deviation: round(100*sd(StockReturns[,"AAPL"]),3)

3. We need to change ad add Yahoo in the dataSet1.R
...
<br>
<br>
1. We need to change the start date in the code
startDate = "2001-01-01"
<br>
<br>
2. we need to add the simboles of companies to myticket, for example:
mytickers = c("SPY", "AAPL","YHOO" , "TSLA", "FB", "MSFT")
<hr>
<hr>
...
**Your Answers here:**
<br>
1. We get 20, because it is counting the number of entries
...
<br>
<br>
2. It gives error because it is trying to add some data that have different formats separated by commas. In addition, the function asks to sum 40 rows when we only have 20 in the data set
<br>
